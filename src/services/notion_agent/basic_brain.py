"""
Basic Brain for Notion AI Agent.
Phase 5: Parses @ai commands and dispatches appropriate actions.
Supports: summarize, status queries, status updates.
"""
import logging
import re
...
class BasicBrain:
    ...
    - "what is the status of X?" / "status of X"
    - "update status to Done" / "mark as Done"
